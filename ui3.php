    ...
    <div class="row">
        ...
        <div class="col-sm-1" >   
            ...
            <ul class="nav nav-tabs nav-stacked" style="height: 90%;">
                ...
                <li data-toggle="modal" data-target="#productPicker" onclick="setDesign();" ><a  data-toggle="tab" href="#priceSection" ><span  >Get Price<span style="visibility: hidden;">spacing</span></span></a></li>
        ...
        <div class="col-sm-4" style="height: 90%;">
            <div class="tab-content" >
                ...
                <div id="productSection" class="tab-pane fade">
                    ...
                    <hr>
                    <div class="btn-group">
                      <button class="btn btn-elegant" style="background-color: #800080;"></button>
                      <button class="btn btn-elegant"  style="background-color: #ff00ff;"></button>
                      <button  class="btn btn-elegant"  style="background-color: #000080;"></button>
                      <button  class="btn btn-elegant"  style="background-color: #0000ff;"></button>
                      <button class="btn btn-elegant"  style="background-color: #008080;"></button>
                      <button class="btn btn-elegant"  style="background-color: #00ffff;"></button>
                    </div>
                    <div class="btn-group">
                      <button class="btn btn-elegant" style="background-color: #008000;"></button>
                      <button class="btn btn-elegant"  style="background-color: #00ff00;"></button>
                      <button  class="btn btn-elegant"  style="background-color: #808000;"></button>
                      <button  class="btn btn-elegant"  style="background-color: #ffff00;"></button>
                      <button class="btn btn-elegant"  style="background-color: #800000;"></button>
                      <button class="btn btn-elegant"  style="background-color: #ff0000;"></button>
                    </div>  
                </div>
                    ...
                    <div >
                        ...
                        <script type="text/javascript">
                            ...
                            function addToCart(){
                                ...
                                cell0.innerHTML = "<div style='width:100%; max-height: 300px; height:100%;  background-image:"+product+"; background-repeat: no-repeat; background-size: cover; background-position: center center;'>"+
                ...
                <!--SHARE SECTION-->
                    ...
                    <script type="text/javascript">
                        ...
                        function getImage(fileAddress){
                            ...
                            //alert(imageLocation.substring(0, imageLocation.indexOf('ui')) + picture);
...
<!--END  NEW PAGE-->
    ...
    <script>
        ...
        */
        ...
        function setColor(){
            colorArt = document.getElementById('color').value;
        }
                ...
                {                   
                   ...
                   // progress(80);
                    ...
                    xhr.onloadend = function(e) {
                        ...
                        $('#mProgressBarModal').modal('hide');
                        getImage(fileAddress);
                        //alert('getImage finished');
                        if(addingToCart){
                            addingToCart = false;
                            //alert('get image should be entered next');
                            getImage(fileAddress);
                            //alert('getImage finished');
                            addToCart();
                        }      
